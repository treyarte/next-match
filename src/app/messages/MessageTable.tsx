...
export default function MessageTable({initialMessages, nextCursor}:Props) {
  const {columns, isDeleting, isOutbox, selectRow, deleteMessage, messages, loadMore, loadingMore, hasMore} = useMessages(initialMessages, nextCursor);
  ...
  return (
    <div className='flex flex-col h-[80vh]'>
      ...
      <Table
        ...
        onRowAction={(key) => selectRow(key as any)}
        shadow='none'
